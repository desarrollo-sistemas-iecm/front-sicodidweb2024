      ...
      :key="category.id" justify="space-around" align="middle">
            ...
            <a-col style="width: 12%; " align="middle" v-if="category.icono != 8 && category.icono != 9 ">
              ...
              <!-- {{  category.icono }} -->
                ...
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-2')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos6['P4']) }}</strong></p>
              ...
              <!-- {{  category.icono }} -->
                ...
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-3')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos8['P5']) }}</strong></p>
              </template>
              ...
              <!-- {{  category.icono }} -->
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-1')" alt=""> <strong>{{ cifrasMiles(votosDistribuidos5['P7']) }}</strong></p>
