...
<template>
  ...
  <div>
      ...
      <!-- FOR CON DATOS-->
      <a-row v-for="(category, index) in categories" 
      :key="category.id" justify="space-around" align="middle">
            <a-col style="width: 100%; " align="middle" v-if="index == 0">
              <a-divider type="horizontal"/>
            </a-col>
            <a-col style="width: 12%; " align="middle" v-if="category.icono != 8 && category.icono != 9 ">
            ...
            <a-col style="width: 12%; " align="middle" v-if="category.icono != 8 && category.icono != 9 ">
              ...
              <!-- {{  category.icono }} -->
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-1')" alt=""> <strong>{{ cifrasMiles(votosDistribuidos5['P4']) }}</strong></p>
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-2')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos6['P4'] + Math.round(decimalesVerde)) }}</strong></p>
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-3')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos7['P4']) }}</strong></p>
              </template>
              <template v-else-if="category.icono == '5'">
              <!-- {{  category.icono }} -->
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-1')" alt=""> <strong>{{ cifrasMiles(votosDistribuidos5['P5']) }}</strong></p>
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-2')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos6['P5']) }}</strong></p>
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-3')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos8['P5'] + Math.round(decimalesPT)) }}</strong></p>
              </template>
              ...
              <!-- {{  category.icono }} -->
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-1')" alt=""> <strong>{{ cifrasMiles(votosDistribuidos5['P7'] + Math.round(decimalesMorena)) }}</strong></p>
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-2')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos7['P7']) }}</strong></p>
                <p><img style="width: 70%; " :src="getImagePathPartidoCoalicion(category.icono+'-3')" alt=""> <strong>+ {{ cifrasMiles(votosDistribuidos8['P7']) }}</strong></p>
              </template>
