<template>
    ...
    <p> 
        Representación del Acta de Resultados de la Casilla Electoral Local de la Elección para <b>{{  eleccion.eleccion === 1 ? 'Jefatura de Gobierno' : (eleccion.eleccion === 2 ? 'Diputaciones' : 'Alcaldía') }}</b>
    </p>
<!--
    VOTOS <br><br>
{{ votos }}
        ...
        <a-col :span="20">
            ...
            <a-row>
                ...
                <a-col :span="4" class="colCenter">
                    Tipo de Casilla
                    <p class="pTitle">
                        <!--                        {{ arreglo[19]? arreglo[19].valor:'S/D' }}{{ arreglo[20]? arreglo[20].valor:'S/D' }}
-->
                        {{ arreglo[19]? arreglo[19].valor:'S/D' }}{{ arreglo[18]? arreglo[18].valor:'S/D' }}
                    </p>
                </a-col>
            </a-row>
            ...
            <a-row>
                ...
                <a-col :span="8" class="colCenter">
                    Fecha y Hora<br>
                    de Impresión:
                    <p class="pTitle" style="padding-right: 4px;">
