...
//getImagePath("partidos" ,"1.jpg") 
    ...
    onBeforeMount(async () => {
        try {
              let item = eleccion.cmb1;
              let item_2 = eleccion.cmb2;
              let item_3 = eleccion.cmb3;
              let type = eleccion.eleccion;   
              
              const urlServer = eleccion.urlPrep;

              ///// OJO!!!!! ESTO ES NUEVO!!!! 08/Mayo/2024
              if(item_2==-1) item_2="";
              ////////////////////////////////

              const  url = urlServer + "funciones_participa.php?type="+type+"&item="+item+"&item_2="+item_2+"&item_3="+item_3;
...
<template>
 ...
 -->
    <Carousel :items-to-show="!isMobile() ? 5 : 1.3" :autoplay="false" :wrap-around="true">
