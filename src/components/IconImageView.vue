...
<template>
  ...
  <div>
    ...
    <a-button type="primary" @click="openImageModal"  
        ...
        <img v-if="registroTMP.ue_qr!=null" style="padding-right: 10px;" class="img_28_2" src="@/assets/votoext/urna.png"> 
        <label v-if="registroTMP.ue_qr!=null"><br>Acta</label> 
        <label v-if="registroTMP.ue_qr==null">Acta</label> 
    </a-button>
    ...
    <Modal :width="800"  :open="imageModalVisible" title="Visor de Imagen de Actas" @cancel="closeImageModal" :footer="null">
        ...
        -->
          ...
          -->
          <UrnaElectronicaDesktop v-if="registroTMP.ue_qr!==null && !isMobile()" :registroLeido="registroTMP"></UrnaElectronicaDesktop>
          <UrnaElectronicaMovil v-else-if="registroTMP.ue_qr!==null && isMobile()" :registroLeido="registroTMP"></UrnaElectronicaMovil>

          <img v-if="registroTMP.ue_qr==null" :src="imageUrl"  @error="setErrorImg" alt="Imagen" style="max-width: 100%; max-height: 100%;" />
...
import UrnaElectronicaDesktop from './UrnaElectronicaDesktop.vue';
import { isMobile } from "../helpers";
import UrnaElectronicaMovil from './UrnaElextronicaMovil.vue';
