<template>
    ...
    <p> 
        Representación del Acta de Resultados de la Casilla Electoral Local de la Elección para <b> 'Diputaciones' </b>
    </p>
<!--
    VOTOS <br><br>
{{ votos }}
        ...
        <a-col :span="20">
            ...
            <a-row>
                ...
                <a-col :span="4" class="colCenter">
                    Circunscripción:
                    <p class="pTitle">
                        {{ arreglo[19]? arreglo[19].valor:'S/D' }}
                    </p>
                </a-col>
                <a-col :span="4" class="colCenter">
                    Sección:
            ...
            <a-row>
                ...
                <a-col :span="8" class="colCenter">
                    ...
                    <p class="pTitle" style="padding-right: 6px;">
                            ...
                            {{ arreglo[28]? new Date(arreglo[28].valor * 1) :'S/D' }}
                ...
                <a-col :span="4" class="colCenter">
                    ...
                    <p class="pTitle">
                        {{ arreglo[9]? parseInt(arreglo[9].valor):'S/D' }}
                    </p>
                </a-col>
      ...
      <!-- TODO: aqui -->
        ...
        <a-row>
            <a-col class="pTitle" :span="12" style="padding: 10px; border-style: ridge;" >
                <div>
                    {{ arreglo[30]? arreglo[30].valor:'S/D' }} 
                </div>
            ...
            <a-col class="pTitle" :span="11" style="padding: 10px; border-style: ridge;">
                {{ arreglo[29]? arreglo[29].valor:'S/D' }}
            </a-col>
        </a-row>
