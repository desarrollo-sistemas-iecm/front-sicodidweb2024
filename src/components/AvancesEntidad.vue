...
<script setup>
    ...
    const tooltips1 = 'La Participación ciudadana es el porcentaje de ciudadanas y ciudadanos que votaron, con base en la Lista Nominal de las Casillas con Actas Computadas. Por ejemplo, si en una casilla votan 500 personas electoras y el número de personas inscritas en la Lista Nominal para esa casilla es de 750, entonces: Multiplicamos 500 por 100 y el resultado lo dividimos entre 750. La votación emitida en las Casillas Especiales se tomará en cuenta para el cálculo de la Participación ciudadana.';
