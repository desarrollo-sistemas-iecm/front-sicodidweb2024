<template>
    ...
    <a-row>
        ...
        <h2 :style="{ color: eleccion.tema ? '': 'white' }">
          ...
          {{ eleccion.eleccion==4? 'Alcaldías': ''}}
           -
         <label style="font-weight: bold; color:#582D73"> Sección </label> 
         <label v-if="cas!='_'" style="color:#582D73"> - Casilla</label>
         <label v-if="cas=='_'" style="color:#582D73"><b> - Casillas</b></label>
        </h2>
    ...
    <GridCasillas titulo="SECCION DOS"></GridCasillas>
